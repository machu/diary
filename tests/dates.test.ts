...
describe("dates utilities", () => {
  ...
  it("getPartFromEntryId extracts pNN from an entry ID or path", () => {
    expect(getPartFromEntryId("20040927p03")).toBe("p03");
    expect(getPartFromEntryId("2004/20040927p07")).toBe("p07");
  });
  ...
  it("groupByDateYmd groups entries by YYYYMMDD", () => {
    const entries: DatedEntry[] = [
      { id: "x/a", data: { date: new Date("2025-01-02") } },
      { id: "x/b", data: { date: new Date("2025-01-03") } },
      { id: "x/c", data: { date: new Date("2025-01-02") } },
    ];
